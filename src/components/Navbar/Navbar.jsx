  ...
  return (
    ...
    {/* Left side */}
      <div className=' flex items-center'>
        ...
        <h1 className=' text-xl sm:text-3xl lg:text-4xl px-2'>Best <span className='font-bold'>Eats</span></h1>
      ...
      {/* Mobile Menu */}
      {/* overlay*/}
      { nav ? <div className=' bg-black/80 fixed w-full z-11 h-screen top-0 left-0'></div> : ""}
